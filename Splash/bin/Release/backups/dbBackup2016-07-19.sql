...
CREATE TABLE `user` (
  ...
  KEY `NameUser` (`Username`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;

-- ----------------------------
--  Records 
-- ----------------------------
INSERT INTO `data_customer` VALUES ('1','PT. MITRA USAHA PERKASA','RUKO CIKUPA NIAGA MAS BLOK B23','021-594009448','pt.mup.developer@gmail.com',NULL,NULL,NULL,NULL),  ('1','PT. MITRA USAHA PERKASA','RUKO CIKUPA NIAGA MAS BLOK B23','021-594009448','pt.mup.developer@gmail.com',NULL,NULL,NULL,NULL),  ('1','PT. MITRA USAHA PERKASA','RUKO CIKUPA NIAGA MAS BLOK B23','021-594009448','pt.mup.developer@gmail.com',NULL,NULL,NULL,NULL),  ('1','PT. MITRA USAHA PERKASA','RUKO CIKUPA NIAGA MAS BLOK B23','021-594009448','pt.mup.developer@gmail.com',NULL,NULL,NULL,NULL);
INSERT INTO `data_proyek` VALUES ('1','BAJA RINGAN TRIRAKSA VILLAGE','PERUMAHAN TRIRAKSA VILLAGE','PT. MITRA USAHA PERKASA','PT. MITRA USAHA PERKASA'),  ('2','BAJA RINGAN TRIRAKSA VILLAGE 2','PERUMAHAN TRIRAKSA VILLAGE 2','PT. MITRA USAHA PERKASA','PT. MITRA USAHA PERKASA'),  ('3','BAJA RINGAN PARAMOUNT SERPONG','CLUSTER VIRGINIA','PARAMOUNT ENTERPRISE INDONESIA','PT. SRIARTAMA SUKSES'),  ('4','BAJA RINGAN PARAMOUNT SERPONG','CLUSTER ARCADIA','PARAMOUNT ENTERPRISE INDONESIA','PT. SERUNI HARUM MAS'),  ('1','BAJA RINGAN TRIRAKSA VILLAGE','PERUMAHAN TRIRAKSA VILLAGE','PT. MITRA USAHA PERKASA','PT. MITRA USAHA PERKASA'),  ('2','BAJA RINGAN TRIRAKSA VILLAGE 2','PERUMAHAN TRIRAKSA VILLAGE 2','PT. MITRA USAHA PERKASA','PT. MITRA USAHA PERKASA'),  ('3','BAJA RINGAN PARAMOUNT SERPONG','CLUSTER VIRGINIA','PARAMOUNT ENTERPRISE INDONESIA','PT. SRIARTAMA SUKSES'),  ('4','BAJA RINGAN PARAMOUNT SERPONG','CLUSTER ARCADIA','PARAMOUNT ENTERPRISE INDONESIA','PT. SERUNI HARUM MAS'),  ('1','BAJA RINGAN TRIRAKSA VILLAGE','PERUMAHAN TRIRAKSA VILLAGE','PT. MITRA USAHA PERKASA','PT. MITRA USAHA PERKASA'),  ('2','BAJA RINGAN TRIRAKSA VILLAGE 2','PERUMAHAN TRIRAKSA VILLAGE 2','PT. MITRA USAHA PERKASA','PT. MITRA USAHA PERKASA'),  ('3','BAJA RINGAN PARAMOUNT SERPONG','CLUSTER VIRGINIA','PARAMOUNT ENTERPRISE INDONESIA','PT. SRIARTAMA SUKSES'),  ('4','BAJA RINGAN PARAMOUNT SERPONG','CLUSTER ARCADIA','PARAMOUNT ENTERPRISE INDONESIA','PT. SERUNI HARUM MAS'),  ('1','BAJA RINGAN TRIRAKSA VILLAGE','PERUMAHAN TRIRAKSA VILLAGE','PT. MITRA USAHA PERKASA','PT. MITRA USAHA PERKASA'),  ('2','BAJA RINGAN TRIRAKSA VILLAGE 2','PERUMAHAN TRIRAKSA VILLAGE 2','PT. MITRA USAHA PERKASA','PT. MITRA USAHA PERKASA'),  ('3','BAJA RINGAN PARAMOUNT SERPONG','CLUSTER VIRGINIA','PARAMOUNT ENTERPRISE INDONESIA','PT. SRIARTAMA SUKSES'),  ('4','BAJA RINGAN PARAMOUNT SERPONG','CLUSTER ARCADIA','PARAMOUNT ENTERPRISE INDONESIA','PT. SERUNI HARUM MAS');
INSERT INTO `datatemp` VALUES ('1','Aplikasi Data Proyek','database'),  ('1','Aplikasi Data Proyek','database'),  ('1','Aplikasi Data Proyek','database'),  ('1','Aplikasi Data Proyek','database');
